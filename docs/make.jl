...
makedocs(
    ...
    pages = [
        ...
        "Examples" => Any["Overview" => "man/examples_overview.md",
                          ...
                          "Electromechanic break" => "models/embrake.md",
                          "Heat 3D PDE" => "models/heat3d.md"],

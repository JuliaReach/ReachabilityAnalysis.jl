...
SET_REPRESENTATIONS = ["Set representations" => ["Introduction"                     => "tutorials/set_representations/introduction.md",
...
UNCERTAIN_INPUTS = ["Modeling uncertain inputs" => ["Introduction"          => "tutorials/uncertain_inputs/introduction.md",
...
HYBRID_SYSTEMS = ["Hybrid systems" => ["Introduction"           => "tutorials/hybrid_systems/introduction.md",
                                       "Square wave oscillator" => "generated_examples/SquareWaveOscillator.md",
                                       "Thermostat model"       => "tutorials/hybrid_systems/thermostat.md"]]

CLOCKED_SYSTEMS = ["Clocked systems" => ["Introduction"           => "tutorials/clocked_systems/introduction.md",

...
function _check_dim(ivp::IVP{<:HybridSystem,<:AbstractWaitingList};
...
#=
function _distribute(ivp::IVP{HS, WL},
...
function _distribute(ivp::IVP{HS, VQT};

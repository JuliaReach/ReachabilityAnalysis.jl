...
@testset "Reach-set constructors" begin
    ...
    R = ReachSet(X, 0 .. 1)
    @test IA.isequal_interval(tspan(R), 0 .. 1)
...
@testset "Overapproximation of Taylor model reach-sets II" begin
    ...
    overapproximate(T, Zonotope; Δt=0.5 .. 1.0, dom=fill(0.9 .. 1.0, 2))

    overapproximate(T, Hyperrectangle)
    overapproximate(T, Hyperrectangle; Δt=0.5 .. 1.0)

    overapproximate(T, Hyperrectangle; Δt=0.5 .. 1.0, dom=fill(0.9 .. 1.0, 2))
    ...
    overapproximate(T, Hyperrectangle)
    overapproximate(T, Hyperrectangle; Δt=0.5 .. 1.0)
    overapproximate(T, Hyperrectangle; Δt=0.5 .. 1.0, dom=[0.9 .. 1.0])
    overapproximate(T, Hyperrectangle; Δt=0.5 .. 1.0, dom=[0.9 .. 1.0])
end
